...
export type ProductGetByIdQuery = { product?: { id: string, name: string, description: string, price: number, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }>, variants: Array<{ id: string, name: string, stage: Stage, color: ProductColor } | { id: string, name: string, stage: Stage, color: ProductColor, size: ProductSize } | { id: string, name: string, stage: Stage, size: ProductSize }> } | null };

export type ProductListItemFragment = { id: string, name: string, description: string, price: number, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }>, variants: Array<{ id: string, name: string, stage: Stage, color: ProductColor } | { id: string, name: string, stage: Stage, color: ProductColor, size: ProductSize } | { id: string, name: string, stage: Stage, size: ProductSize }> };

type ProductListItemVariants_ProductColorVariant_Fragment = { id: string, name: string, stage: Stage, color: ProductColor };

type ProductListItemVariants_ProductSizeColorVariant_Fragment = { id: string, name: string, stage: Stage, color: ProductColor, size: ProductSize };

type ProductListItemVariants_ProductSizeVariant_Fragment = { id: string, name: string, stage: Stage, size: ProductSize };

export type ProductListItemVariantsFragment = ProductListItemVariants_ProductColorVariant_Fragment | ProductListItemVariants_ProductSizeColorVariant_Fragment | ProductListItemVariants_ProductSizeVariant_Fragment;
...
export type ProductsGetBySlugQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }>, variants: Array<{ id: string, name: string, stage: Stage, color: ProductColor } | { id: string, name: string, stage: Stage, color: ProductColor, size: ProductSize } | { id: string, name: string, stage: Stage, size: ProductSize }> }> };
...
export type RelatedProductsGetListQuery = { products: Array<{ id: string, name: string, description: string, price: number, categories: Array<{ name: string, slug: string }>, images: Array<{ url: string }>, variants: Array<{ id: string, name: string, stage: Stage, color: ProductColor } | { id: string, name: string, stage: Stage, color: ProductColor, size: ProductSize } | { id: string, name: string, stage: Stage, size: ProductSize }> }> };
...
export const ProductListItemVariantsFragmentDoc = new TypedDocumentString(`
  ...
  ... on ProductSizeVariant {
    ...
    `, {"fragmentName":"ProductListItemVariants"}) as unknown as TypedDocumentString<ProductListItemVariantsFragment, unknown>;
...
}`) as unknown as TypedDocumentString<CollectionsGetByCategorySlugQuery, CollectionsGetByCategorySlugQueryVariables>;
...
}`) as unknown as TypedDocumentString<ProductsGetBySlugQuery, ProductsGetBySlugQueryVariables>;
...
}`) as unknown as TypedDocumentString<RelatedProductsGetListQuery, RelatedProductsGetListQueryVariables>;